                    ...
                    <div className="grid w-full grid-cols-8 gap-16">
                        <div className="col-span-3 flex flex-col items-start justify-start">
                            ...
                            <p className="font-medium">
                                Hi, I&apos;m AY, a web developer and UI/UX designer with a passion for creating beautiful, functional, 
                        ...
                        >
                            ...
                            <Image src={profilePic} alt="AY" className='w-full h-auto rounded-2xl'
                                priority
                        ...
                        <div className="col-span-2 flex flex-col items-end justify-between">
                            ...
                            <div className="flex flex-col items-end justify-center">
                                ...
                                <h2 className="text-xl font-medium capitalize text-dark/75 dark:text-light/75">yars of experience</h2>
                            </div>
                        </div>
                    </div>
                    <Skills />
